...
class CI_Email {
	...
	var	$useragent		= "ICGC RI - Empowerment Temple";
	var	$mailpath		= "/usr/sbin/sendmail";	// Sendmail path
	var	$protocol		= "smtp";	// mail/sendmail/smtp
	var	$smtp_host		= "mail.centralgospelri.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "centralg";		// SMTP Username
	var	$smtp_pass		= "centralgospel123";		// SMTP Password
	var	$smtp_port		= "26";		// SMTP Port
	var	$smtp_timeout           = 60;		// SMTP Timeout in seconds
	var	$smtp_crypto            = "null";
